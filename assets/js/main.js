    ...
    <footer class="wf-footer">
      <div class="wrap">
        <div class="wf-footer__inner">
          ...
          <div class="wf-footer__legal" style="margin-top:10px; font-family:var(--font-mono); font-size:9px; letter-spacing:2px; text-transform:uppercase; color:var(--text-3);">
            <a href="/impressum.html" data-i18n="footer.impressum" style="color:var(--text-3); text-decoration:none; transition:color 0.15s;" onmouseover="this.style.color='var(--text-1)'" onmouseout="this.style.color='var(--text-3)'">Impressum</a>
            <span style="margin:0 8px;">·</span>
            <a href="/datenschutz.html" data-i18n="footer.datenschutz" style="color:var(--text-3); text-decoration:none; transition:color 0.15s;" onmouseover="this.style.color='var(--text-1)'" onmouseout="this.style.color='var(--text-3)'">Datenschutz</a>
          </div>
        </div>
      </div>
    </footer>
